...
<div class="not-prose grid grid-cols-1 md:grid-cols-3 gap-6 my-12">
  <div class="cs-direction-card">
    ...
    <h3 class="text-lg font-bold text-normal dark:text-inverted mb-3">Technical & Editorial</h3>
  ...
  <div class="cs-direction-card">
    ...
    <h3 class="text-lg font-bold text-normal dark:text-inverted mb-3">Quiet & Literate</h3>
  ...
  <div class="cs-direction-card">
    ...
    <h3 class="text-lg font-bold text-normal dark:text-inverted mb-3">Futurist & Expressive</h3>
...
<div class="not-prose grid grid-cols-1 gap-6 my-10">
  <div class="standard-card text-left">
    ...
    <h3 class="text-xl font-bold text-normal dark:text-inverted mb-3">The Game of Life as the Brand's Living Signature</h3>
  ...
  <div class="standard-card text-left">
    ...
    <h3 class="text-xl font-bold text-normal dark:text-inverted mb-3">Grayscale as a Positioning Statement</h3>
  ...
  <div class="standard-card text-left">
    ...
    <h3 class="text-xl font-bold text-normal dark:text-inverted mb-3">Type-Only, No Imagery</h3>
  ...
  <div class="standard-card text-left">
    ...
    <h3 class="text-xl font-bold text-normal dark:text-inverted mb-3">Logo System as Modular Set, Not Single Mark</h3>
