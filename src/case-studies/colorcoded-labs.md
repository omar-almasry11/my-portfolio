...
description: "Turning a vibrant standalone identity into a digital brand language for a tech education company in Columbus, Ohio."
...
card-img: "/images/png/ccl-card-cover.svg"
card-img-width: 1600
card-img-height: 1200
header-img: "/images/colorcoded-labs-hero.webp"
header-img-width: 2510
header-img-height: 1430
header_subtitle: "Brand System & Website"
header-overview: "Turning a vibrant identity into a digital brand language — one that delivers on the company's own name and scales for web and digital marketing use."
header_meta:
  - label: "Client"
    value: "ColorCoded Labs"
  - label: "Industry"
  ...
  <div class="flex items-baseline gap-6 border-b border-normal dark:border-inverted pb-8">
    ...
    <div class="flex flex-col">
      ...
      <div class="flex gap-3 mt-4">
        <span class="text-xs uppercase tracking-widest opacity-40">Extra Bold</span>
        <span class="text-xs uppercase tracking-widest opacity-40">Bold</span>
        <span class="text-xs uppercase tracking-widest opacity-40">Regular</span>
      </div>
    </div>
  </div>
  <div class="max-w-3xl">
